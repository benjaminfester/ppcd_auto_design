...
// returns true if length and width passes ver4a, 4b, 5, 6 and 7
verifyFromLengthAndWidth = () => {
    ...
    // verified
    if(!temp.includes(0)) {
        return [true, length, width, volume]
    } else {
        return [false, length, width, volume]
    }
}
module.exports.verifyFromLengthAndWidth = verifyFromLengthAndWidth
