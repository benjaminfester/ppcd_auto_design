...
P_bez_0_ud_st_l = matix.get_P_bez_0_ud_st_l(column_shape, column_length, column_radius, m_total_ud_st_l, a_ud_st_l_1, R_A_ud_st_l_1, M_A_ud_st_l_1, w_ud_st_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius, L_w_ud_st_l_2, R_A_ud_st_l_2, M_A_ud_st_l_2, a_ud_st_l_2)
P_bez_3_ud_st_l = matix.get_P_bez_3_ud_st_l(column_shape, column_length, column_radius, m_total_ud_st_l, a_ud_st_l_1, R_A_ud_st_l_1, M_A_ud_st_l_1, w_ud_st_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius, L_w_ud_st_l_2, R_A_ud_st_l_2, M_A_ud_st_l_2, a_ud_st_l_2)
P_bez_1_ud_st_l = matix.get_P_bez_1_ud_st_l(m_total_ud_st_l, a_ud_st_l_1, R_A_ud_st_l_1, M_A_ud_st_l_1, w_ud_st_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius, L_w_ud_st_l_2, R_A_ud_st_l_2, M_A_ud_st_l_2, a_ud_st_l_2)
P_bez_2_ud_st_l = matix.get_P_bez_2_ud_st_l(m_total_ud_st_l, a_ud_st_l_1, R_A_ud_st_l_1, M_A_ud_st_l_1, w_ud_st_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius, L_w_ud_st_l_2, R_A_ud_st_l_2, M_A_ud_st_l_2, a_ud_st_l_2) 
P_bez_0_ud_lt_l = matix.get_P_bez_0_ud_lt_l(column_shape, column_length, column_radius, m_total_ud_lt_l, a_ud_lt_l_1, R_A_ud_lt_l_1, M_A_ud_lt_l_1, w_ud_lt_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius)
P_bez_3_ud_lt_l = matix.get_P_bez_3_ud_lt_l(column_shape, column_length, column_radius, m_total_ud_lt_l, a_ud_lt_l_1, R_A_ud_lt_l_1, M_A_ud_lt_l_1, w_ud_lt_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius)
P_bez_1_ud_lt_l = matix.get_P_bez_1_ud_lt_l(m_total_ud_lt_l, a_ud_lt_l_1, R_A_ud_lt_l_1, M_A_ud_lt_l_1, w_ud_lt_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius)
P_bez_2_ud_lt_l = matix.get_P_bez_2_ud_lt_l(m_total_ud_lt_l, a_ud_lt_l_1, R_A_ud_lt_l_1, M_A_ud_lt_l_1, w_ud_lt_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius)
P_bez_0_dim_l = matix.get_P_bez_0_dim_l(column_shape, column_length, column_radius, m_dim_length, a_dim_l_1, R_A_dim_l_1, M_A_dim_l_1, w_dim_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius, L_w_dim_l_2, R_A_dim_l_2, M_A_dim_l_2, a_dim_l_2)
P_bez_3_dim_l = matix.get_P_bez_3_dim_l(column_shape, column_length, column_radius, m_dim_length, a_dim_l_1, R_A_dim_l_1, M_A_dim_l_1, w_dim_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius, L_w_dim_l_2, R_A_dim_l_2, M_A_dim_l_2, a_dim_l_2)
P_bez_1_dim_l = matix.get_P_bez_1_dim_l(m_dim_length, a_dim_l_1, R_A_dim_l_1, M_A_dim_l_1, w_dim_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius, L_w_dim_l_2, R_A_dim_l_2, M_A_dim_l_2, a_dim_l_2)
P_bez_2_dim_l = matix.get_P_bez_2_dim_l(m_dim_length, a_dim_l_1, R_A_dim_l_1, M_A_dim_l_1, w_dim_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius, L_w_dim_l_2, R_A_dim_l_2, M_A_dim_l_2, a_dim_l_2)
fn_B_dr_st_l = matix.get_fn_B_dr_st_l(P_bez_1_dr_st_l, P_bez_2_dr_st_l, P_bez_0_dr_st_l, P_bez_3_dr_st_l, column_shape, column_length, column_radius)
fn_B_dr_lt_l = matix.get_fn_B_dr_lt_l(P_bez_1_dr_lt_l, P_bez_2_dr_lt_l, P_bez_0_dr_lt_l, P_bez_3_dr_lt_l, column_shape, column_length, column_radius) 
fn_B_ud_st_l = matix.get_fn_B_ud_st_l(P_bez_1_ud_st_l, P_bez_2_ud_st_l, P_bez_0_ud_st_l, P_bez_3_ud_st_l, column_shape, column_length, column_radius)
fn_B_ud_lt_l = matix.get_fn_B_ud_lt_l(P_bez_1_ud_lt_l, P_bez_2_ud_lt_l, P_bez_0_ud_lt_l, P_bez_3_ud_lt_l, column_shape, column_length, column_radius)
fn_B_dim_l = matix.get_fn_B_dim_l()

fn_M_dr_st_l_corr = matix.get_fn_M_dr_st_l_corr(x, m_total_dr_st_l, column_shape, column_length, column_radius, a_dr_st_l_1, R_A_dr_st_l_1, M_A_dr_st_l_1, w_dr_st_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius, L_w_dr_st_l_2, R_A_dr_st_l_2, M_A_dr_st_l_2, a_dr_st_l_2, P_bez_1_dr_st_l, P_bez_2_dr_st_l, P_bez_0_dr_st_l, P_bez_3_dr_st_l)
fn_M_dr_lt_l_corr = matix.get_fn_M_dr_lt_l_corr(x, m_total_dr_lt_l, column_shape, column_length, column_radius, a_dr_lt_l_1, R_A_dr_lt_l_1, M_A_dr_lt_l_1, w_dr_lt_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius, L_w_dr_lt_l_2, R_A_dr_lt_l_2, M_A_dr_lt_l_2, a_dr_lt_l_2, P_bez_1_dr_lt_l, P_bez_2_dr_lt_l, P_bez_0_dr_lt_l, P_bez_3_dr_lt_l)
fn_M_ud_st_l_corr = matix.get_fn_M_ud_st_l_corr(x, m_total_ud_st_l, column_shape, column_length, column_radius, a_ud_st_l_1, R_A_ud_st_l_1, M_A_ud_st_l_1, w_ud_st_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius, L_w_ud_st_l_2, R_A_ud_st_l_2, M_A_ud_st_l_2, a_ud_st_l_2, P_bez_1_ud_st_l, P_bez_2_ud_st_l, P_bez_0_ud_st_l, P_bez_3_ud_st_l)
fn_M_ud_lt_l_corr = matix.get_fn_M_ud_lt_l_corr(x, m_total_ud_lt_l, column_shape, column_length, column_radius, a_ud_lt_l_1, R_A_ud_lt_l_1, M_A_ud_lt_l_1, w_ud_lt_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius, L_w_ud_lt_l_2, R_A_ud_lt_l_2, M_A_ud_lt_l_2, a_ud_lt_l_2, P_bez_1_ud_lt_l, P_bez_2_ud_lt_l, P_bez_0_ud_lt_l, P_bez_3_ud_lt_l)

fn_M_dim_l_corr = matix.get_fn_M_dim_l_corr(x, m_dim_length, column_shape, column_length, column_radius, a_dim_l_1, R_A_dim_l_1, M_A_dim_l_1, w_dim_l, point_foundation_shape, w_sw_l, length, ec_vl_length, radius, L_w_dim_l_2, R_A_dim_l_2, M_A_dim_l_2, a_dim_l_2)
