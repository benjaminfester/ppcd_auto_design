...
for(x=0; x<lengths.length;x++) {
    ...
    fn_B_dr_st_l = matix.get_fn_B_dr_st_l()
    fn_B_dr_lt_l = matix.get_fn_B_dr_lt_l() 
    fn_B_ud_st_l = matix.get_fn_B_ud_st_l()
    fn_B_ud_lt_l = matix.get_fn_B_ud_lt_l()
    fn_B_dim_l = matix.get_fn_B_dim_l()
    fn_M_dr_st_l_corr = matix.get_fn_M_dr_st_l_corr(x)
    fn_M_dr_lt_l_corr = matix.get_fn_M_dr_lt_l_corr(x)
    fn_M_ud_st_l_corr = matix.get_fn_M_ud_st_l_corr(x)
    fn_M_ud_lt_l_corr = matix.get_fn_M_ud_lt_l_corr(x)
    ...
    fn_M_dr_st_b_corr = matix.get_fn_M_dr_st_b_corr(x)
    fn_M_dr_lt_b_corr = matix.get_fn_M_dr_lt_b_corr(x)
    fn_M_ud_st_b_corr = matix.get_fn_M_ud_st_b_corr(x)
    fn_M_ud_lt_b_corr = matix.get_fn_M_ud_lt_b_corr(x)
